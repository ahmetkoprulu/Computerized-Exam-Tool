    ...
    if not self.ids["input_grade"].text.strip():
        ...
        if self.question_type == "programming":
            ...
            data = {"QuestionTypeId": 2,
                    ...
                    "ExamId":Cache.get("CurrentExam", "id"),
                    "Num": 1,
                    "extra": json.dumps(yson)}


            # database_api.addQuestionToExam(CourseOfferingID=Cache.get("CurrentExam","id"))
